  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your team with HR Management System - streamlining employee data, time tracking, payrolls, and performance evaluations all in one central hub. Manage with ease, excel in performance."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your team with HR Management System - streamlining employee data, time tracking, payrolls, and performance evaluations all in one central hub. Manage with ease, excel in performance.`}
            </Text>
            <Box
